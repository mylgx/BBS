	...
	<div class="index-box" style="z-index: 9999; position: relative">
		...
		<div class="index-body">
			<div class="nav-sliders">
				<a id="loginButton" class="login active">重置密码</a> <span class="on"></span>
			</div>
			<div class="change">
			<a
							href="<%=request.getContextPath()%>/repasswordServlet?action=toindex"
							target="_blank"><span>&nbsp;&nbsp;</span><span></span></a>
							
				<!--登录开始-->
				<div class="login-box">
					<form id="loginForm"
						 action="${pageContext.request.contextPath}/repasswordServlet"
						method="post">
						<div class="wrap">
							<div class="phone">
						...
						<input  type="submit" class="button" onclick="show()" value="确定">
